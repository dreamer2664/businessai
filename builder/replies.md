...
- 2026-09-08 20:30 (builder): New: a chat page in your browser. On the PC (PowerShell): `wsl bash -lc "cd ~/businessai && git pull -q && python3 scripts/talk.py"` → opens http://localhost:8787 — type at the bottom, my answers appear in the same window. This chat window here replaces the broken one; I read it every time I wake and answer here.
- 2026-09-08 21:05 (builder): If you see this, the browser chat works. Type below — I answer here.
