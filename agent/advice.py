...
class Advice:
    ...
    RULES = [
        ...
        (r"\b(?:should (?:i|we)|worth|conviene|do (?:i|we)|is it worth|good idea)\b.{0,20}?\b(?:offer|add|do|give|propose|adding|offering|offrire|fare)\b.{0,10}?\bgift[- ]?wrap(?:ping)?\b|\bgift[- ]?wrap(?:ping)?\b.{0,20}?\b(?:yes or no|worth|good idea|\?)|\bconfezione regalo\b.{0,20}?(?:conviene|\?)", "gift_wrap"),
